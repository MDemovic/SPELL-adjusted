...
def load_owl(file: str): #=> Added class assertions
    ...
    nsmap = {}
    abox = ABoxBuilder()
    individual_to_class = {}  # Map individuals to their rdf:type class
    num = len(abox.indmap)
        ...
        if elem.tag == tag_class:
            ...
            for child in elem:
                if child.tag in tag_type:
                    ...
                    individual_to_class[a] = conceptname  # Track individual-class link
